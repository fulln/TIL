...
---
there is total <!-- count starts -->86<!-- count ends --> TILs . keep on study
...
* [一个有名的按摩师会收到源源不断的预约请求，每个预约都可以选择接或不接。在每次预约服务之间要有休息时间，因此她不能接受相邻的预约。给定一个预约请求序列，替按摩师找到最优的预约集合（总预约时间最长），返回总的分钟数。](https://github.com/fulln/TIL/blob/master/leetcode/easy/massage.md) - 2020-10-10
### middle

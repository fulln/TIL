---
title: "Washing your code: avoid reassigning variables by Artem Sapegin"
url: https://sapegin.me/blog/avoid-reassigning-variables/
date: 2024-02-18 11:22:25
tags:
  - code
---
...
And most of the time we can avoid both. Let’s start with reassigning and come back to mutation in the [next chapter](https://sapegin.me/blog/avoid-mutation/).
...
Unfortunately, JavaScript has no true constants, and *mutation* is still possible even when we define a variable with the `const` keyword. We’ll talk about mutations in [the next chapter](https://sapegin.me/blog/avoid-mutation/).
...
-   [Naming is hard](https://sapegin.me/blog/naming/)
-   *Avoid reassigning variables (*this post*)*
-   [Avoid mutation](https://sapegin.me/blog/avoid-mutation/)
-   [Avoid loops](https://sapegin.me/blog/avoid-loops/)
-   [Avoid conditions](https://sapegin.me/blog/avoid-conditions/)
-   [Avoid comments](https://sapegin.me/blog/avoid-comments/)